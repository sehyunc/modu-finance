...
const VaultForm: React.FC<VaultFormProps> = ({
  ...
  const footerText = isDeposit
    ...
    : `Your Position: ${positionReadable} Share(s)`
  ...
  const WithdrawButton = (
    <SubmitButton handleClick={handleWithdraw} text="Withdraw Shares" />
  )
  ...
  const StakeDaoTokenSelect = isDeposit ? (
